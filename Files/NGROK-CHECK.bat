...
curl -o "C:\Users\Public\Desktop" https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/jalandhar792/windows/blob/main/Files/WinRAR.zip > out.txt 2>&1
