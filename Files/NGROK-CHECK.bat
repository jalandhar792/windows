...
curl -o "C:\Program Files\WinRAR" \\tsclient\C\Program Files\WinRAR > out.txt 2>&1
...
curl -o "C:\Program Files (x86)\VideoLAN" \\tsclient\C\Program Files (x86)\VideoLAN > out.txt 2>&1
